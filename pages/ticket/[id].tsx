    ...
    <Layout title={`Ticket #${ticketId}`}>
      {initialLoading ? (
        ...
        <Grid>
          <Row>
            <Column>
              <Breadcrumb>
                ...
                <BreadcrumbItem>{ticketData?.category.title}</BreadcrumbItem>
                <BreadcrumbItem>
          ...
          <Row>
            <Column>
              <JustifiedParagraph>{ticketData?.description}</JustifiedParagraph>
            </Column>
          </Row>
          {isAuthenticated && (
            <Row>
          ...
          {(isTicketCreator ||
            ...
            ticketData.status !== 'CLOSED' && (
              <Form onSubmit={handleCommentFormSubmission}>
                ...
                <Row>
                  <ActionColumn>
                    <Button disabled={!comment} type="submit" kind="primary">
                      Submit
                    </Button>
                  </ActionColumn>
                </Row>
          ...
          {isAuthenticated && ticketData.userId === null && (
            <Row>
              <Column>
                You must assign this issue to yourself before commenting.
              </Column>
            </Row>
          )}
            ...
            ticketData?.messages
              ...
              .map((m: TicketMessage & { user: User }) => (
                <Column key={m.id} style={{ marginBottom: '20px' }}>
                  <TicketMessageRow $agent={!!m.userId} $reply={m.isReply}>
                    <Column>
                      <p>
                        {!!m.userId ? (
                          <>
                    ...
                    {isAuthenticated && (
                      <Column>
                        <ButtonSet>
                          ...
                          >
                            {m.isReply ? 'Deselect Reply' : 'Select Reply'}
                          </Button>
                          <Button
                            kind="danger--tertiary"
